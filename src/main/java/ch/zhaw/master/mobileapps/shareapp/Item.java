...
public class Item {
	...
	final static String FIELDNAME_PICTURE = "picture";
	...
	public Item(@JsonProperty(FIELDNAME_OWNER_ID) String ownerId, @JsonProperty(FIELDNAME_TITLE) String title,
			...
			@JsonProperty(FIELDNAME_PICTURE) String picture) {
	...
	public Item(String ownerId, UUID itemId, String title, String category, String description, String city,
			String zipCode, String telephoneNumber, String address, String picture) {
		this.ownerId = ownerId;
		this.itemId = itemId;
		this.title = title;
		this.category = category;
